...
我们知道现在字符串匹配查找算法最好的就是kmp算法了，看了很多写kmp算法的文章，但我个人觉得几乎没有一个人真的讲清楚了这个算法的核心。

我一直有个观点：对一件事你如果真的懂了，是能一句话给出这个事物的本质的。算法更是如此。你只有真正懂了，高度抽象化了，形成了自己的思维，才能将这种思想进行迁移，对解决更多的场景和问题。
...
#### next数组的每个元素表示匹配串中从起始到以当前字符结尾的字符串中以当前字符结尾的连续重复最长串长度。eg:
